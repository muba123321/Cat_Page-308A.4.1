...
var API_KEY = "live_d4ardeTARUwUI0RKDZwqVPI3WsT4Qnp1clzN5ro91mtSfugd3ti6xXqmPXsUl6cF";
...
breedSelect.addEventListener("change", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  var _images$, res, images, breedInfo;
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        breedId = breedSelect.value;
        console.log(_typeof(breedId));
        _context.prev = 2;
        _context.next = 5;
...
_axios.default.interceptors.request.use(function (config) {
  ...
  console.log("Request started at:", new Date(config.metadata.startTime).toLocaleString());
...
_axios.default.interceptors.response.use(function (response) {
  ...
  console.log("Request completed in ".concat(duration, " ms"));
...
function updateProgress(progressEvent) {
  ...
  var percentCompleted = Math.round(current / total * 100);
  ...
  _favourite = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(imgId) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 4:
          getFavourite = _context3.sent;
          console.log(getFavourite.data);
          favouriteExist = getFavourite.data.some(function (favourite) {
          ...
          idToDelete = getFavourite.data.find(function (favourite) {
            return favourite.image_id === imgId;
          }).id;
          _context3.next = 12;
          return _axios.default.delete("https://api.thecatapi.com/v1/favourites/".concat(idToDelete), {
            headers: {
              "x-api-key": API_KEY
            }
          });
        case 12:
          deleteFavourite = _context3.sent;
          console.log('///////////////');
        ...
        case 25:
          ...
          console.error("Error creating favourite:", _context3.t0);
        case 28:
        case "end":
...
},{"bootstrap":"node_modules/bootstrap/dist/js/bootstrap.esm.js","./index.js":"index.js"}],"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","Carousel.js"], null)
